...
class ImagePopupManager {
    ...
    setupDragAndResize() {
        ...
        if (this.popupElements.imagePopup) {
            const popupNav = this.popupElements.imagePopup.querySelector('.popup-nav');
            if (popupNav) {
    ...
    openPopup(imageIndex) {
        try {
            ...
            this.popupElements.popupImage.onload = () => {
                ...
                this.popupElements.imagePopup.style.width = optimalSize.width + 'px';
                this.popupElements.imagePopup.style.height = optimalSize.height + 'px';
    ...
    startDrag(e) {
        ...
        const popupRect = this.popupElements.imagePopup.getBoundingClientRect();
        ...
        this.popupUtils.addDraggingState(this.popupElements.imagePopup);
    ...
    drag(e) {
        ...
        this.popupUtils.setPosition(this.popupElements.imagePopup, newX, newY);
    }
    ...
    stopDrag(e) {
        ...
        this.popupUtils.removeDraggingState(this.popupElements.imagePopup);
    ...
    startResize(e) {
        ...
        // Add resizing state
        this.popupElements.imagePopup.classList.add('resizing');
    ...
    resize(e) {
        ...
        this.popupElements.imagePopup.style.top = newTop + 'px';
        this.popupElements.imagePopup.style.transform = 'none';
    }
    ...
    stopResize(e) {
        ...
        this.popupElements.imagePopup.classList.remove('resizing');
